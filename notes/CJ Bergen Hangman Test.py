...
letters = truly_random_word[0] + truly_random_word[1] + truly_random_word[2] + truly_random_word[3] + \
          truly_random_word[4] + truly_random_word[5] + truly_random_word[6] + truly_random_word[7] + \
          truly_random_word[8] + truly_random_word[9]
...
while guesses > 0 and not word_guessed == truly_random_word:
    ...
    word_guessed = list(letter_guessed1 + letter_guessed2 + letter_guessed3 + letter_guessed4 + letter_guessed5 +
